#pragma checksum "C:\Users\swarchuck\source\repos\CarpetHandyMan\CarpetHandyMan.Blazor\Shared\NavMenu.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "515eb636a44eb6f53326ca950b93ac20918862ac"
// <auto-generated/>
...
#nullable disable
    public partial class NavMenu : Microsoft.AspNetCore.Components.ComponentBase
    {
        ...
        {
            __builder.AddMarkupContent(0, @"<nav class=""bg-gray-800""><div class=""max-w-7xl mx-auto px-2 sm:px-6 lg:px-8""><div class=""relative flex items-center justify-between h-16""><div class=""flex-1 flex items-center justify-center sm:items-stretch sm:justify-start""><div class=""hidden sm:block sm:ml-6""><div class=""flex space-x-4""><a href class=""bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium"" aria-current=""page"">Home</a>
