#pragma checksum "C:\Users\swarchuck\source\repos\CarpetHandyMan\CarpetHandyMan.Blazor\Shared\NavMenu.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e47632737b9546f9fa47d4dc83eb24be513a0434"
// <auto-generated/>
...
#nullable disable
    public partial class NavMenu : Microsoft.AspNetCore.Components.ComponentBase
    {
        ...
        {
            __builder.AddMarkupContent(0, @"<nav class=""bg-gray-800""><div class=""max-w-7xl mx-auto px-2 sm:px-6 lg:px-8""><div class=""relative flex items-center justify-between h-16""><div class=""flex-1 flex items-center justify-center sm:items-stretch sm:justify-start""><div class=""hidden sm:block sm:ml-6""><div class=""flex space-x-4""><a href class=""text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium"">Home</a>
